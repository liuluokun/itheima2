...
<body>
    ...
    <div class="nav">
        <ul class="breadcrumb" style="margin: 0px">
            <li style="line-height: 36px"><a href="${pageContext.request.contextPath}/WEB-INF/pages/index.jsp">首页</a></li>
        </ul>
    </div>
    ...
    <div class="container-fluid content">
        <div class="row-fluid">
                    ...
                    <div class="accordion-group">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner">
                                <a href="${pageContext.request.contextPath}/WEB-INF/pages/index.jsp">
            ...
            <div class="span10 content-right">
                <iframe src="${pageContext.request.contextPath}/cust/listCust" class="iframe"></iframe>
            </div>
        </div>
    </div>
