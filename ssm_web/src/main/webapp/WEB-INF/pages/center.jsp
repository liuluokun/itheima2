...
<div class="container-fluid">
    <div class="row-fluid">
        <h4>数据列表</h4>
        <div>
            <form action="${pageContext.request.contextPath}/cust/selectByCondition" method="post">
                ...
                <table class="table table-condensed table-bordered table-hover tab">
                    ...
                    <c:forEach items="${list}" var="cust">
                        <tr>
                            ...
                            <td><a href="${pageContext.request.contextPath}/cust/delete?cid=${cust.cid}">删除</a></td>
                        </tr>
                     </c:forEach>
                    </tbody>
                </table>
        ...
        <div id="addModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="add_form" action="${pageContext.request.contextPath}/cust/add" method="post">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" id="add" onclick="x()">保存</button>
            </div>
        </div>
    </div>
</div>
